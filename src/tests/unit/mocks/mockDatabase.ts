...
export class MockDatabase {
    ...
    public publishStateObjects(...objects: ioBroker.PartialObject[]): void {
        objects.map(obj => extend({}, obj, { type: 'state' })).forEach(this.publishObject.bind(this));
    }
    public publishChannelObjects(...objects: ioBroker.PartialObject[]): void {
        objects.map(obj => extend({}, obj, { type: 'channel' })).forEach(this.publishObject.bind(this));
    }
    public publishDeviceObjects(...objects: ioBroker.PartialObject[]): void {
        objects.map(obj => extend({}, obj, { type: 'device' })).forEach(this.publishObject.bind(this));
    }
    ...
    public publishState(id: string, state: Partial<ioBroker.State> | null | undefined): void {
    ...
    public publishStates(states: Record<string, Partial<ioBroker.State> | null | undefined>): void {
