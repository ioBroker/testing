...
export function testAdapterWithMocks(
	...
	describe(`Unit tests`, async () => {
		...
		if (typeof options.defineAdditionalTests === "function") {
			...
			it("DEPRECATED!", () => {
				console.warn(
					"\u001b[33mUnit tests for adapter startup are deprecated!",
				);
				console.warn(
					`If you do not define your own tests, you can remove the "test:unit" script`,
				);
				console.warn(
					`from package.json and from your Travis/Github Actions workflow.\u001b[0m`,
				);
			});
		}
	});
