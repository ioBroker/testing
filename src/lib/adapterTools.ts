...
export function getAdapterExecutionMode(adapterDir: string): ioBroker.AdapterCommon['mode'] {
...
export function getAdapterDependencies(adapterDir: string): Record<string, string> {
    const ioPackage = loadIoPackage(adapterDir);
